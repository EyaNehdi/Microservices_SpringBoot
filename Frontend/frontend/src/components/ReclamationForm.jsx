...
function ReclamationForm({ refreshReclamations, editingReclamation, setEditingReclamation }) {
  ...
  const sendEmailNotification = () => {
    ...
    emailjs
      .send("service_hgqse9n", "template_d0jpkze", templateParams, "R-frxwk22uHudOKxD")
      ...
      <form onSubmit={handleSubmit} className="reclamation-form">
        <div className="form-group">
          ...
          <input
            ...
            className={errors.titre ? "form-control input-error" : "form-control"}
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={handleChange}
            className={errors.date ? "form-control input-error" : "form-control"}
          />
        ...
        <div className="form-group">
          ...
          <select
            ...
            onChange={handleChange}
            className={errors.type_reclamation ? "form-control input-error" : "form-control"}
          >
        ...
        <div className="form-buttons">
          {editingReclamation && (
            <button type="button" className="cancel-btn" onClick={() => setEditingReclamation(null)}>
              Annuler
            </button>
          )}
